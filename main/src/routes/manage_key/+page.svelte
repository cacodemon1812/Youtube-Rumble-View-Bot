...
<div id="form_container">
	<div class="settings_container container_gray">
		...
		<div class="same_line premium_line">
			<p>To get a free access to a subset of the bot's features,</p>
			<p>You must watch 3 ads.</p>
		</div>

		<div class="same_line premium_line">
			<p>
				To get access to the limited free subset of the bot's features, you must watch 3 ads daily
				on <a href="https://www.bloxxy.net/api/linkvertise/0">our website</a>.
			</p>
		</div>
		...
		<div class="api_inserter">
			<div class="same_line premium_line">
				<p>
					After watching the 3 ads and copying the API key, paste it here, it'll automatically
					refresh the page IF they key is correct:
				</p>

				<input
					type="text"
					class="premium_textbox"
					bind:value={data.free_api_key}
	...
	<div class="settings_container second_container container_rainbow">
		...
		<div class="same_line premium_line">
			...
			<p>This will also remove all ads for the month present.</p>
		</div>
